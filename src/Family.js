...
import { Form, Row, Button, Card, CardBody, Col } from "reactstrap";
        ...
        <CardBody className="p-30">
          <Row form className="form-row-card">
            <Col md="12" className="m-t-10 m-b-10">
              <h5 className="font-weight-bold">Parents Info</h5>
            ...
            <Col md="4">
              ...
              >
                ...
                <option value="Norther">Northern</option>
          ...
          <Row form className="form-row-card">
            <Col md="12" className="m-t-10 m-b-10">
              <h5 className="font-weight-bold">Marital Detials</h5>
              <hr className="line-divider" />
            </Col>
            <Col md="4">
              <Field
          ...
          <Row form className="form-row-card">
            <Col md="12" className="m-t-10 m-b-10">
              <h5 className="font-weight-bold">Dependents</h5>
              <hr className="line-divider" />
            </Col>
            <Col md="4">
              <Field
            ...
            <Col md="4">
              <Field
                ...
                name="depenentDateOfBirth1"
              />
            </Col>

            <Col md="4">
              <Field component={renderSelectField} name="dependentRelation1">
